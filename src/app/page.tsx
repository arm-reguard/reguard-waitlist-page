...
export default function Home() {
  ...
  return (
    <AuroraBackground>
      ...
      <div className="relative z-10 flex flex-col items-center justify-start md:justify-center min-h-screen px-4 text-center pt-[76px] md:pt-32">
        {/* Main Headline */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.1 }}
          className="mb-7 md:mb-10 max-w-5xl"
        >
        ...
        <motion.div
          ...
          className="mt-9 md:mt-20 flex justify-center gap-8 sm:gap-12"
        >
        ...
        <motion.div
          ...
          className="mt-7 md:mt-10 mb-2 md:mb-8"
        >
          <motion.div
            animate={{
              scale: [1, 1.05, 1],
