    ...
    <AuroraBackground>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center pt-24 sm:pt-24 md:pt-0">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4 text-sm text-zinc-300">
            {/* First row - 3 items */}
