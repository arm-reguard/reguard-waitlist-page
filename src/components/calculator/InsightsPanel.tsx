          ...
          <div className="space-y-2 text-sm text-zinc-300">
            ...
            {hasGPT5 && (
              <p className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">GPT-5.2 / GPT-5.2 pro:</strong> Best for marketing copy, technical documentation, structured content, and data analysis. Excels at following specific formatting instructions.
                </span>
              </p>
            )}
            {hasOpus && (
