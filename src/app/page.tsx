...
export default function Home() {
  ...
  return (
    <AuroraBackground>
      ...
      <div className="relative z-10 flex flex-col items-center justify-start md:justify-center min-h-screen px-4 text-center pt-[68px] md:pt-32">
        {/* Main Headline */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          ...
          className="mb-6 md:mb-16 max-w-3xl w-full flex justify-center sm:hidden"
        >
        ...
        <motion.div
          ...
          className="mt-6 md:mt-10 mb-2 md:mb-8"
        >
          <motion.div
            animate={{
              scale: [1, 1.05, 1],
